...
class TestConfigList:
    def test_lists_all_keys_as_defaults(self, temp_home, capsys):
        ...
        for key in (
            ...
            "autoswitch.model",
            "autoswitch.preferredAccount",
            "autoswitch.preferencePct",
            "ui.theme",
        ):
            assert key in out
    ...
    def test_json_list(self, temp_home, capsys):
        ...
        assert by_key["autoswitch.preferredAccount"]["value"] is None
        assert by_key["autoswitch.preferredAccount"]["isSet"] is False
        assert by_key["autoswitch.preferencePct"]["value"] == 10.0
